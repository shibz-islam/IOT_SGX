...
static sgx_status_t SGX_CDECL Enclave_ocall_get_message_from_enclave(void* pms)
{
	ms_ocall_get_message_from_enclave_t* ms = SGX_CAST(ms_ocall_get_message_from_enclave_t*, pms);
	ocall_get_message_from_enclave(ms->ms_msg);
...
static const struct {
	...
	12,
	{
		...
		(void*)Enclave_ocall_get_message_from_enclave,
...
sgx_status_t ecall_decrypt_message(sgx_enclave_id_t eid, struct message* msg)
{
	sgx_status_t status;
...
sgx_status_t ecall_encrypt_message(sgx_enclave_id_t eid, struct message* msg)
{
	sgx_status_t status;
...
sgx_status_t ecall_decrypt_rule(sgx_enclave_id_t eid, struct message* msg)
{
	sgx_status_t status;
	ms_ecall_decrypt_rule_t ms;
	ms.ms_msg = msg;
