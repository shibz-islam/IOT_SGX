...
#endif
#ifndef OCALL_GET_MESSAGE_FROM_ENCLAVE_DEFINED__
#define OCALL_GET_MESSAGE_FROM_ENCLAVE_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_message_from_enclave, (struct message* msg));
#endif
